...
class _HomeState extends State<Home> {
  ...
  void filterByCategory(String category) {
    setState(() {
      ...
      if (category.isEmpty) {
        ...
        eventStream = DatabaseMethods().getEventsByCategory(category);
      }
    });
  }

  void scrollToEvents() {
    // prikaži sve događaje od početka
  ...
  Widget _categoryCard(String image, String title) {
    return GestureDetector(
                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _categoryCard("images/sports.png", "Sport"),
                      const SizedBox(width: 30),
                      _categoryCard("images/video.png", "Film"),
                      const SizedBox(width: 30),
                      _categoryCard("images/theatre.png", "Pozorište"),
                    ],
                  ),
                ),
                const SizedBox(height: 20.0),
